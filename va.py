...
def virtual_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen().lower()
        edict = {'divya':'divyasri.motamarri.com'} #give mail ids
        toaddr = edict[to]
        ...
        mail.starttls()
        #login
        mail.login('divyasri.motamarri@gmail.com','eapb uyug wjzx koex') #enter mailid and app password make sure you enable less secure app access
        mail.sendmail('divyasri.motamrri@gmail.com',toaddr,content) #enter your gmail username
        mail.close()
        respond('Email Sent')
