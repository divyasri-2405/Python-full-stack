#exception handling-It will show error in information format

#try->Instructions from which we are expecting the exceptions

#except->exceptions are raised in try block it will handle by this block
...
#Regular expressions are powerful tools(embedded in python) which is mainly used to find a pattern within a given string or statements or files and we mainly use it for text manipulation
